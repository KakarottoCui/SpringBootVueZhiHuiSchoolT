	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"var(--publicMainColor)","headFontSize":"24px","headUserInfoFontColor":"#fff","headBoxShadow":"0px 0px 0px 10px var(--publicSubColor) inset","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"var(--publicSubColor)","headFontColor":"#fff","headTitleImg":false,"headHeight":"80px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"var(--publicMainColor)","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"#fff","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
