<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:40px;backgroundColor:var(--publicMainColor);borderRadius:0;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px var(--publicSubColor);borderWidth:0;borderStyle:dotted solid double dashed;borderColor:var(--publicSubColor);">
