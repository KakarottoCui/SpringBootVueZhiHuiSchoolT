    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">智慧校园管理系统注册</h1>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // if('jiaoshi' == this.tableName && (this.ruleForm.dataDelete== null ||this.ruleForm.dataDelete== "")){
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/xiaoyuanjiankangyz/img/back-img-bg.jpg);
