    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="填报标题" prop="jiankangtianbaoName">
                       <el-input v-model="ruleForm.jiankangtianbaoName"
                                 placeholder="填报标题" clearable  :readonly="ro.jiankangtianbaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="填报标题" prop="jiankangtianbaoName">
                           <el-input v-model="ruleForm.jiankangtianbaoName"
                                     placeholder="填报标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="当前体温" prop="jiankangtianbaoTiwen">
                       <el-input v-model="ruleForm.jiankangtianbaoTiwen"
                                 placeholder="当前体温" clearable  :readonly="ro.jiankangtianbaoTiwen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="当前体温" prop="jiankangtianbaoTiwen">
                           <el-input v-model="ruleForm.jiankangtianbaoTiwen"
                                     placeholder="当前体温" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="填报详情" prop="jiankangtianbaoText">
                        <el-input type="textarea"  :readonly="ro.jiankangtianbaoText" v-model="ruleForm.jiankangtianbaoText" placeholder="填报详情"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangtianbaoText" label="填报详情" prop="jiankangtianbaoText">
                            <span v-html="ruleForm.jiankangtianbaoText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    jiankangtianbaoName: false,
                    jiankangtianbaoTiwen: false,
                    jiankangtianbaoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    jiankangtianbaoName: '',
                    jiankangtianbaoTiwen: '',
                    jiankangtianbaoText: '',
                    insertTime: '',
                },
                yonghuOptions : [],
                rules: {
                   ...
                   jiankangtianbaoName: [
                              { required: true, message: '填报标题不能为空', trigger: 'blur' },
                          ],
                   jiankangtianbaoTiwen: [
                              { required: true, message: '当前体温不能为空', trigger: 'blur' },
                   ...
                   jiankangtianbaoText: [
                              { required: true, message: '填报详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiankangtianbao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiankangtianbaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
