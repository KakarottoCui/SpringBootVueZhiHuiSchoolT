               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体检服务名称" prop="tijianName">
                       <el-input v-model="ruleForm.tijianName"
                                 placeholder="体检服务名称" clearable  :readonly="ro.tijianName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.tijianPhoto" label="体检服务照片" prop="tijianPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.tijianPhoto?$base.url+ruleForm.tijianPhoto:''"
                            @change="tijianPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="体检服务类型" prop="tijianTypes">
                        <el-select v-model="ruleForm.tijianTypes" :disabled="ro.tijianTypes" placeholder="请选择体检服务类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体检费用" prop="tijianPrice">
                       <el-input v-model="ruleForm.tijianPrice"
                                 placeholder="体检费用" clearable  :readonly="ro.tijianPrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.tijianContent"  label="体检服务介绍" prop="tijianContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tijianContent" label="体检服务介绍" prop="tijianContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   tijianName: [
                              { required: true, message: '体检服务名称不能为空', trigger: 'blur' },
                          ],
                   tijianPhoto: [
                              { required: true, message: '体检服务照片不能为空', trigger: 'blur' },
                          ],
                   tijianTypes: [
                              { required: true, message: '体检服务类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   tijianPrice: [
                              { required: true, message: '体检费用不能为空', trigger: 'blur' },
                   ...
                   tijianClicknum: [
                              { required: true, message: '体检服务热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   tijianContent: [
                              { required: true, message: '体检服务介绍不能为空', trigger: 'blur' },
                          ],
                   dataDelete: [
        ...
        methods: {
            ...
            //图片
            tijianPhotoUploadChange(fileUrls){
                this.ruleForm.tijianPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
