        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanjiankangyz/upload/yonghuMuBan.xls"
                        >批量导入学生数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="账户" prop="username" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                    ...
                    <el-table-column label="学生身份证号" prop="yonghuIdNumber" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.yonghuIdNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column label="学生头像" prop="yonghuPhoto" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center" width="200">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="性别" prop="sexTypes" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.sexValue}}
                        </template>
                    </el-table-column>
                    <el-table-column label="学生邮箱" prop="yonghuEmail" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.yonghuEmail}}
                        </template>
                    </el-table-column>
                    <el-table-column label="添加时间" prop="insertTime" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
