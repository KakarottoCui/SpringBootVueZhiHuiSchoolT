    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="jiankangyizhanLiuyanText">
                        <el-input type="textarea"  :readonly="ro.jiankangyizhanLiuyanText" v-model="ruleForm.jiankangyizhanLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangyizhanLiuyanText" label="留言内容" prop="jiankangyizhanLiuyanText">
                            <span v-html="ruleForm.jiankangyizhanLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    jiankangyizhanLiuyanText: false,
                    insertTime: false,
                    replyText: false,
                    updateTime: false,
                },
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.jiankangyizhanId = true;//驿站
                this.ro.yonghuId = true;//学生
                this.ro.jiankangyizhanLiuyanText = true;//留言内容
            }else{
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `jiankangyizhanLiuyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiankangyizhanLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiankangyizhanLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
