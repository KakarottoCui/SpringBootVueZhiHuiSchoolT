    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="请假缘由" prop="yonghuqingjiaText">
                        <el-input type="textarea"  :readonly="ro.yonghuqingjiaText" v-model="ruleForm.yonghuqingjiaText" placeholder="请假缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yonghuqingjiaText" label="请假缘由" prop="yonghuqingjiaText">
                            <span v-html="ruleForm.yonghuqingjiaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="请假类型" prop="yonghuqingjiaTypes">
                        <el-select v-model="ruleForm.yonghuqingjiaTypes" :disabled="ro.yonghuqingjiaTypes" placeholder="请选择请假类型">
                            <el-option
                                v-for="(item,index) in yonghuqingjiaTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="请假类型" prop="yonghuqingjiaValue">
                        <el-input v-model="ruleForm.yonghuqingjiaValue"
                            placeholder="请假类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.yonghuqingjiaTime"  class="input" label="请假时间" prop="yonghuqingjiaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yonghuqingjiaTime"
                                type="datetime"
                                placeholder="请假时间"
                                :disabled="ro.yonghuqingjiaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yonghuqingjiaTime" label="请假时间" prop="yonghuqingjiaTime">
                            <span v-html="ruleForm.yonghuqingjiaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假天数" prop="yonghuqingjiaNumber">
                       <el-input v-model="ruleForm.yonghuqingjiaNumber"
                                 placeholder="请假天数" clearable  :readonly="ro.yonghuqingjiaNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="请假天数" prop="yonghuqingjiaNumber">
                           <el-input v-model="ruleForm.yonghuqingjiaNumber"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yonghuqingjiaYesnoTypes" label="申请状态" prop="yonghuqingjiaYesnoTypes">
                        <el-input v-model="ruleForm.yonghuqingjiaYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yonghuqingjiaYesnoText" label="处理意见" prop="yonghuqingjiaYesnoText">
                        <span v-html="ruleForm.yonghuqingjiaYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yonghuqingjiaShenheTime" label="审核时间" prop="yonghuqingjiaShenheTime">
                        <span v-html="ruleForm.yonghuqingjiaShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghuqingjia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuqingjiaTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghuqingjia_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuqingjiaYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yonghuqingjia/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yonghuqingjiaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
