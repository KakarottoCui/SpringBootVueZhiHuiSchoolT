    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="tijianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.tijianLiuyanText" v-model="ruleForm.tijianLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tijianLiuyanText" label="留言内容" prop="tijianLiuyanText">
                            <span v-html="ruleForm.tijianLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.tijianId = true;//体检服务
                this.ro.yonghuId = true;//学生
                this.ro.tijianLiuyanText = true;//留言内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`tijianLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.tijianLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
