        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanjiankangyz/upload/jiaoshiMuBan.xls"
                        >批量导入教师数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jiaoshi','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="教师名称" prop="jiaoshiName" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.jiaoshiName}}
                        </template>
                    </el-table-column>
                    <el-table-column label="教师手机号" prop="jiaoshiPhone" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.jiaoshiPhone}}
                        </template>
                    </el-table-column>
                    <el-table-column label="教师头像" prop="jiaoshiPhoto" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center" width="200">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="教师邮箱" prop="jiaoshiEmail" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
