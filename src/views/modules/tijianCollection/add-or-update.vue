    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="tijianCollectionTypes">
                        <el-select v-model="ruleForm.tijianCollectionTypes" :disabled="ro.tijianCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in tijianCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="tijianCollectionValue">
                        <el-input v-model="ruleForm.tijianCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    tijianId: false,
                    yonghuId: false,
                    tijianCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    tijianId: '',
                    yonghuId: '',
                    tijianCollectionTypes: '',
                    insertTime: '',
                },
                tijianCollectionTypesOptions : [],
                tijianOptions : [],
                yonghuOptions : [],
                rules: {
                   tijianId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tijian_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tijianCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`tijianCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.tijianCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
